          ...
          if (updateWords)
          {
            ...
            if (lastModifiedWordView_ != null)
            {
              ...
              scrollView.post(new Runnable()
              {
                ...
                //get Candidate word
                //Log.i("myLog","last modified: "+lastModifiedWordView.word.label);
                EditorView.setWord(lastModifiedWordView.word.label);
            }
          }
